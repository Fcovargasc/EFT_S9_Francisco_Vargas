...
public class Teatro {
    ...
    public static void main(String[] args) {
        //teatro moro 
        //primero parto por importar todo lo que usare en este caso es el Scanner y arrayList
        //defino uvariables para darle vida al scanner y tambien defino  los precios y descuentos en distintas variables para tenerlas a mano cuando las necesite
        ...
        //ahora creo lo que me gusta llamar el esqueleto de mi codigo donde creo el menu principal del programa
        ...
        //despues de crear el menu principal usando un switch y case  hago mi primera verificacion con un do while para que repita si se  pone un numero
        //fuera del rango establecido y es cuando hago la primera prueba para ver si los fundamentos funcionan bien
       
        switch(opcion){
            case 1: 
                //despues de verificar que el menu funcione comienzo rellenar los case de a uno
                System.out.println("Venta de Boletos");
                
                //6.creo el menu el cual lo ara elegir un tipo de asiento
